<template>
    <div class="flex flex-col items-start absolute ViewCard left-2 bottom-8 mb-16 z-50 w-[305px]" @click.stop>
    ...
    <WebSetting v-if="targetSettingPage === 'WebSetting'" />
    <VoiceSetting v-if="targetSettingPage === 'VoiceSetting'" />
